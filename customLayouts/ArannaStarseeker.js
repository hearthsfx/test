    ...
    <View style={{flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start'}}>
      ...
      <View style={{justifyContent: 'space-around'}}>
        <View style={{flexDirection: 'row', justifyContent: 'space-around', marginBottom: 8}}>
          ...
          <View style={{padding: 4}} />
          <SoundButton title='Attack (2)' cardID={props.cardID} sound='A2' />
          <View style={{padding: 4}} />
        ...
        <View style={{flexDirection: 'row', justifyContent: 'flex-start', marginBottom: 8}}>
          <SoundButton title='Thinking (4)' cardID={props.cardID} sound='T4' />
          <View style={{padding: 4}} />
    ...
    <View style={{flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start'}}>
      ...
      <View style={{justifyContent: 'space-around'}}>
        <View style={{flexDirection: 'row', justifyContent: 'space-around', marginBottom: 8}}>
          ...
          <View style={{padding: 4}} />
          <SoundButton title='Threaten (1)' cardID={props.cardID} sound='EM_T' />
        </View>
        <View style={{flexDirection: 'row', justifyContent: 'flex-start', marginBottom: 8}}>
          <SoundButton title='Threaten (2) ' cardID={props.cardID} sound='EM_T2' />
          <View style={{padding: 4}} />
    ...
    <View style={{flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start'}}>
      ...
      <View style={{justifyContent: 'space-around'}}>
        <View style={{flexDirection: 'row', justifyContent: 'space-around', marginBottom: 8}}>
          ...
          <View style={{padding: 4}} />
          <SoundButton title='Mana (1)' cardID={props.cardID} sound='E2' />
          <View style={{padding: 4}} />
          <SoundButton title='Mana (2)' cardID={props.cardID} sound='E2A' />
          <View style={{padding: 4}} />
...
export default ArannaStarseeker
